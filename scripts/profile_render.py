...
HERO_TEMPLATE = Template("""<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="360" viewBox="0 0 1200 360" role="img" aria-labelledby="hero-title">
  <title id="hero-title">Hix-001 profile hero</title>
  <style>
  ...
  <text class="mono ink" x="1152" y="56" font-size="11" letter-spacing="3" text-anchor="end">$location</text>
  ...
  <g transform="translate(313,138) scale(0.52) rotate(-3 50 50)">
  ...
  <text class="serif ink" x="48" y="254" font-size="16" font-style="italic">
    <tspan x="48" dy="0">$abstract_line1</tspan>
    <tspan x="48" dy="22">$abstract_line2</tspan>
  </text>
    ...
    *,
    ...
    return HERO_TEMPLATE.substitute(
        **theme,
        ...
        tagline=tagline,
        location=location,
        abstract_line1=abstract_line1,
        abstract_line2=abstract_line2,
    )
